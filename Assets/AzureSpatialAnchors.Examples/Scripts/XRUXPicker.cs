...
namespace Microsoft.Azure.SpatialAnchors.Unity.Examples
{
    ...
    public class XRUXPicker : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            //GameObject wifi = GameObject.Find("Wifi");
            //wifi.SetActive(false);
            //GameObject wifiState = GameObject.Find("Wifi State");
            //wifiState.SetActive(false);
            //GameObject bluetooth = GameObject.Find("Bluetooth");
            //bluetooth.SetActive(false);
            //GameObject bluetoothState = GameObject.Find("Bluetooth State");
            //bluetoothState.SetActive(false);
            //GameObject geolocation = GameObject.Find("GeoLocation");
            //geolocation.SetActive(false);
            //GameObject geolocationState = GameObject.Find("GeoLocation State");
            //geolocationState.SetActive(false);
            GameObject resultLabel = GameObject.Find("result");
            resultLabel.SetActive(false);
            //GameObject blockLeftNumber = GameObject.Find("blocksLeftNumber");
            //int leftNumber = 10;
