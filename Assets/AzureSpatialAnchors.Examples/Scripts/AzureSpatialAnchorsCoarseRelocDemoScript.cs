...
namespace Microsoft.Azure.SpatialAnchors.Unity.Examples
{
    public class AzureSpatialAnchorsCoarseRelocDemoScript : DemoScriptBase
    {
        ...
        public override void Update()
        {
            ...
            GameObject blockLeftNumber = GameObject.Find("blockLeftNumber");
            int leftNumber = 20;
            blockLeftNumber.GetComponent<Text>().text = leftNumber.ToString();
        ...
        /// <summary>
        /// Author: Licheng
        /// Method Name: ChangeBlockN()
        /// Return Type: void
        /// Function: change Anchored Object Prefab based on pressed grid
        /// </summary>
        public void ChangeBlock1()
        {
            GameObject newObj = Instantiate(Resources.Load("Cliff")) as GameObject;
            setBlock(newObj);
        }

        public void ChangeBlock2()
        {
            GameObject newObj = Instantiate(Resources.Load("Dirt")) as GameObject;
            setBlock(newObj);
        }

        public void ChangeBlock3()
        {
            GameObject newObj = Instantiate(Resources.Load("Grass_01")) as GameObject;
            setBlock(newObj);
        }

        public void ChangeBlock4()
        {
            GameObject newObj = Instantiate(Resources.Load("Grass_02")) as GameObject;
            setBlock(newObj);
        }

        public void ChangeBlock5()
        {
            GameObject newObj = Instantiate(Resources.Load("Rock")) as GameObject;
            setBlock(newObj);
        }

        public void ChangeBlock6()
        {
            GameObject newObj = Instantiate(Resources.Load("Sand")) as GameObject;
            setBlock(newObj);
        }

        public void ChangeBlock7()
        {
            GameObject newObj = Instantiate(Resources.Load("Wood")) as GameObject;
            setBlock(newObj);
        }

        public void ChangeBlock8()
        {
            GameObject newObj = Instantiate(Resources.Load("Cursor")) as GameObject;
            setBlock(newObj);
        }
    }
}
